import type { CardDefinition, EnemyBaseStats } from "../types";
...
import { syncTowerHealthCapacity, type TowerHealthObserver } from "./towerHealthRules";
...
export function syncTowerFinalStats(
  ...
  onHealthChanged?: TowerHealthObserver
) {
  ...
  syncTowerHealthCapacity(tower, previousMaxHp, !!options.healMaxHpIncrease, onHealthChanged);
}
