...
const HEART_LEAD_LANE_RADIUS = 1;
...
export {
  HEX_ARMOR_RADIUS, HEX_ARMOR_RANK_ONE_BONUS, HEX_ARMOR_BONUS_PER_EXTRA_RANK,
  HEX_SPELL_BULWARK_RANK_ONE_MAGIC_RESISTANCE_BONUS, HEX_SPELL_BULWARK_MAGIC_RESISTANCE_BONUS_PER_EXTRA_RANK,
  HEX_HEAL_SKILL_MAX, HEX_HEAL_SKILL_COST, HEX_HEAL_SKILL_REGEN_PER_SECOND, HEX_HEAL_RATIO,
  CHARGING_HEX_SPEED_MULTIPLIER, LEADER_SPEED_MULTIPLIER,
  HEART_LEAD_SKILL_MAX, HEART_LEAD_SKILL_COST, HEART_LEAD_REGEN_PER_SECOND, HEART_LEAD_COLUMN_SPAN, HEART_LEAD_LANE_RADIUS,
  ANGEL_WINGS_SKILL_COST, ANGEL_WINGS_REGEN_PER_SECOND, ANGEL_WINGS_DURATION, ANGEL_WINGS_RANGE_X, ANGEL_WINGS_RANGE_Y,
  ARCHANGEL_ASCENSION_SKILL_MAX, ARCHANGEL_ASCENSION_SKILL_COST, ARCHANGEL_ASCENSION_REGEN_PER_SECOND,
  ARCHANGEL_ASCENSION_DURATION, ARCHANGEL_ASCENSION_RADIUS, ANGEL_WINGS_SPEED_MULTIPLIER
};
