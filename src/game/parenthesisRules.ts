...
import { canJoinEnemyGroup, enemyMaximumHp, parenthesisHalfSpan, PASSENGER_STAT_RATIO } from "./enemyContainerRules";
...
export interface ParenthesisPresentation {
  carrier(enemy: Enemy): void;
  position(enemy: Enemy): void;
}
...
export function collectParenthesisPassengers(carrier: Enemy, enemies: Enemy[], time: number, presentation: ParenthesisPresentation, previous?: EnemyPositions) {
