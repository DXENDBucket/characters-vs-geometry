...
function towerUpgradeText(id: CardId) {
  ...
  if (id === "+") return isZh() ? "每有效等级增加 25 颗缓存和每秒 25 颗处理上限。" : "Each effective level adds 25 capacity and 25 shots/s processing.";
