...
export function towerUpgradeText(id: CardId) {
  ...
  if (id === "*") return isZh() ? "每有效等级增加 128 份缓存，升级保留库存；3:1 的法术伤害抵消比例和保护范围不变。" : "Each effective level adds 128 capacity, retaining stock. The 3:1 magic absorption ratio and protection range stay unchanged.";
