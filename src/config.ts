...
export const AIR_PATROL_SKILL_DURATION = 6_000;
...
> = {
  del: { hp: 500_000, armor: 150, magicResistance: 20, speed: 0, hitboxCells: 3 },
...
export const ICOSAHEDRON_BOSS_LEAP_SKILL_MAX = 50;
export const ICOSAHEDRON_BOSS_LEAP_SKILL_COST = 50;
export const ICOSAHEDRON_BOSS_LEAP_INITIAL_SP = 35;
...
export const SPELL_MORTAR_SHOT_INTERVAL = 500;
export const SPELL_MORTAR_AOE_RANGE_X = CELL_WIDTH * 1.5;
export const SPELL_MORTAR_AOE_RANGE_Y = CELL_HEIGHT * 1.5;
