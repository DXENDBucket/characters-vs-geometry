...
- The rule suite includes 675 tests plus four math, thirteen durable-host and
  fifteen ownership tests in its pretest hook.
...
Platform/content coverage still needs expansion. Per-player resources,
