...
| + | Defense | Square | 2400 | 60s | 3000 | 500 | 0 | Unlocked after AE-3. 400 physical retaliation. Adds the combined individual final max HP of the stronger complete vertical or horizontal adjacent pair, with each neighbor costing <=999. Capacity changes preserve health ratio. | Conversion starts at 100%, +15 percentage points per effective upgrade; own base HP stays 3000 |
...
- Clear reward: `+`, ASCII Expansion defense tower. Cost 2400, cooldown 60s, base HP 3000, armor 500, MR 0, physical retaliation 400 (same as B).
- A complete vertical or horizontal pair of adjacent towers costing at most 999 each contributes its combined individual final max HP to +. Uses the larger pair, never both together. Conversion starts at 100%, plus 15 percentage points per extra effective upgrade. Its own base HP stays 3000; changes preserve current health ratio, including when sharing a u pool.
