...
| + | Function | Triangle | 1000 | 30s | 1200 | 150 | 0 | Unlocked after AE-4. Ordinary source plus groups share learned-kind counts without extra source actions. In numeric groups, every + counts at the whole group's sum; original numbers retain their own behavior. Numbers cannot be added to ordinary towers. | +1 own imitation multiplier for numeric groups, added to highest equals level minus 1; interval unchanged |
