...
| = | Special | Edge | 50 | 3s | 0 | 0 | 0 | Unlocked after AE-3. Internal-edge connector; click cycles bidirectional, forward, backward and closed. No ammo storage or attackable body. | +25 shots/s flow per level; supports auto-upgrades |
...
| + | Function | Triangle | 50 | 3s | 1200 | 150 | 0 | Processor: exactly five compatible shots become one, retaining separate judgments. Outputs finished shots first; results can be bundled again. | +25 capacity and +25 shots/s processing per effective level |
...
- Pipeline components =, 0, 1 and + cost 50 with 3s cooldown; - costs 500 with 10s cooldown. The ordinary nodes retain the 1200 HP / 150 armor / 0 MR / 0 ATK panel. Stack 0 cards to upgrade bank capacity without losing inventory or turning into 1. Zero supports auto-upgrades and extraction batches. Outlet 1 still cannot auto-upgrade.
