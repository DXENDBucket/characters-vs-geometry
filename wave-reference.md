...
| @ | Function | Copied / Triangle | 1000 | 60s | 1200 | 150 | 0 | Unlocked after AE-2. Continuously copies the regular tower one cell ahead with base cost <=999; excludes instant targeted effect cards and ASCII characters. Copies base stats, mechanics and border, retaining its own label, facing, card identity and HP ratio. No valid target means no additional ability. | Uses copied upgrade rules at its own effective level |
...
- Continuously copies the regular character in the immediately forward cell if its base cost is at most 999, excluding instant targeted effect cards (`b`, `t`, `y`) and ASCII Expansion characters. Facing changes alter the observed cell. An absent or ineligible target leaves @ without extra abilities.
