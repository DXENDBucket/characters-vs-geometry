...
| = | Function | Triangle | 1000 | 60s | 1200 | 150 | 0 | Unlocked after AE-3. Opposite horizontal/vertical neighbors teach number towers the identity and behavior of sources costing <=999. Chains share memories, not counters. | / |
...
- Opposite neighbors across an Equals connector teach a number tower sources costing <=999, both horizontally and vertically. A=1=2 shares A's source identity and behavior; each number counts independently. A=1=E records A and E separately. Only the recorded source towers count, not unrelated towers of the same kind. Memories survive disconnection; deceased source identities are discarded without forgetting the behavior or accumulated count.
