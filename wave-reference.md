...
| + | Function | Triangle | 1000 | 30s | 1200 | 150 | 0 | Retired action-sharing/arithmetic operator; not part of the projectile-circuit prototype. | / |
| - | Function | Triangle | 1000 | 30s | 1200 | 150 | 0 | Retired action-sharing/arithmetic operator; not part of the projectile-circuit prototype. | / |
...
- Clear rewards: `+`, `-` and `&`.
- `+` and `-` are inactive during this prototype; the prior count-sharing, arithmetic and imitation behaviors are retired.
